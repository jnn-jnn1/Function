    ...
    <Center>
      <Box>
        ...
        <Flex mt={5} justifyContent={"center"} gap={7}>
          <a href="http://54.180.228.71:8080/oauth2/authorization/kakao">
            <Image
              width={"50px"}
          ...
          <a href="http://54.180.228.71:8080/oauth2/authorization/google">
            <Image
              width={"50px"}
          ...
          <a href="http://54.180.228.71:8080/oauth2/authorization/naver">
            <Image
              width={"50px"}
